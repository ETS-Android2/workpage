...
public class EditTaskContextDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        nameEditText = (EditText) view.findViewById(R.id.editTaskContext_name);
        ...
        nameEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (enabled) {
                    ...
                    enabled = (newContext.equals(EditTaskContextDialogFragment.this.context) || !EditTaskContextDialogFragment.this.contexts.contains(newContext));
                }
