...
public class AdvancedColorPickerDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        blueEditText = (EditText) view.findViewById(R.id.advancedColorPicker_blue);
