...
public class FileAdapter extends ArrayAdapter<File> {
    ...
    public View getView(int position, View itemView, ViewGroup parentViewGroup) {
        ...
        ImageView fileIconImageView = (ImageView) itemView.findViewById(R.id.file_list_item_icon);
        TextView fileNameTextView = (TextView) itemView.findViewById(R.id.file_list_item_name);
